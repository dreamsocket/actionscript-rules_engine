...
package com.dreamsocket.rules 
{
	...
	{
		public static const EQUAL_TO:String = "eq";
		public static const CONTAINS:String = "ct";
		public static const GREATER_THAN_EQUAL_TO:String = "ge";
		public static const GREATER_THAN:String = "gt";		
		public static const LESS_THAN_EQUAL_TO:String = "le";
		public static const LESS_THAN:String = "lt";
		public static const NOT_EQUAL_TO:String = "ne";
